...
@Component({
  ...
  template: `
    <section class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <form class="flex flex-wrap items-end gap-3" [formGroup]="form" (ngSubmit)="submit()">
        ...
        <div class="flex flex-col">
          ...
          <input
            ...
            class="w-28 rounded-md border border-slate-300 px-3 py-1.5 text-sm focus:border-indigo-500 focus:outline-none"
          />
        </div>
        <div class="flex flex-col">
        ...
        <button
          ...
          class="rounded-md bg-indigo-600 px-4 py-1.5 text-sm font-semibold text-white hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Crear pago
        </button>
